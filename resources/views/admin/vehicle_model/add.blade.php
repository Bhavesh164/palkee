@extends('admin.layout.master',['title' => 'Add Vehicle Model'])
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-12  layout-spacing">
                            <div class="statbox widget box box-shadow">
                                ...
                                <div class="widget-content widget-content-area">
                                    ...
                                    @endif
                                    <form action="{!! url('admin/vehicle_model') !!}" method="post" enctype="multipart/form-data" autocomplete="off">
                                         @csrf
                                        ...
                                        <div class="form-group row  mb-2">
                                            ...
                                            <div class="col-sm-6">
                                                <select class="form-control select2" name="vehicle_make_id" id="vehicle_make" required="">
                                                    ...
                                                    <option value="{{$vehicle_make->id}}">{{$vehicle_make->make_name}}</option>
                                                    @endforeach
                                        ...
                                        <div class="form-group row  mb-4">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" class="form-control form-control-sm" id="model_name" name="model_name" placeholder="Model Name">
                                            </div>
                                        </div>
                                        <div class="form-group row mb-4">
