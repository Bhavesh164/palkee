...
@extends('admin.layout.master',['title' => $content_management->page_title])
        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-12  layout-spacing">
            <div class="statbox widget box box-shadow">
                <div class="widget-header">                                
                    <div class="row">
                        <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                            <h4>Edit {{$content_management->page_title}}</h4>
                        </div>
                    </div>
                </div>
                ...
                <div class="widget-content widget-content-area">
                    ...
                    ?>
                    <form action="{{action('Admin\content_managementController@content_update')}}" method="post" enctype="multipart/form-data" autocomplete="off">
                        {{csrf_field()}}                       
                        ...
                        */ ?>
                         <div class="form-group">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                ...
                                <label for="page_content" class="col-form-label col-form-label-sm">{{$content_management->page_title}}</label>
                                ...
                                <input type="hidden" value="{{$content_management->page_name}}" name="page_name">
