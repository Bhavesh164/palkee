@extends('admin.layout.master',['title' => 'Add Driver'])
      ...
      <div class="statbox widget box box-shadow">
        ...
        <div class="widget-content widget-content-area icon-tab">
          ...
          <ul class="nav nav-tabs  mb-3 mt-3" id="iconTab" role="tablist">
            <li class="nav-item">
              <a class="nav-link active" id="driver-info-tab" data-toggle="tab" href="#driver_info" role="tab" aria-controls="icon-home" aria-selected="true">
                <i class="fas fa-user"></i> Driver Info 
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link disabled" id="icon-car-info" data-toggle="tab" href="#car-info" role="tab" aria-controls="icon-contact" aria-selected="false">
                <i class="fas fa-car"></i> Vehicle Info</a>
              </li>
              <li class="nav-item">
                <a class="nav-link disabled" id="icon-documents" data-toggle="tab" href="#documents" role="tab"  tabindex="-1" aria-controls="icon-contact" aria-selected="false">
                ...
                <div class="tab-pane fade show active" id="driver_info" role="tabpanel" aria-labelledby="driver-info-tab">
                  ...
                  <form action="{!! url('admin/driver') !!}" method="post" enctype="multipart/form-data" autocomplete="off">
                    ...
                    <div class="form-group row  mb-4">
                      ...
                      <div class="col-sm-6">
                        <input type="text" class="form-control form-control-sm" id="rider_name" name="full_name" placeholder="Full Name" required="" value="{{ old('full_name') }}">
                      </div>
                    </div>
                    <div class="form-group row  mb-4">
                      <label for="email" class="col-sm-2 col-form-label col-form-label-sm">Email</label>
                      <div class="col-sm-6">
                        <input type="text" class="form-control form-control-sm" id="email" name="email" placeholder="Email" required="" value="{{ old('email') }}">
                      </div>
                    </div>
                    <div class="form-group row  mb-4">
                      <label for="dob" class="col-sm-2 col-form-label col-form-label-sm">D.O.B</label>
                      <div class="col-sm-6">
                        <input type="text" class="form-control form-control-sm" id="dob" name="dob" placeholder="D.O.B" required="" value="{{old('dob')}}">
                      </div>
                    </div>
                    <div class="form-group row  mb-4">
                      <label for="phone" class="col-sm-2 col-form-label col-form-label-sm">Phone</label>
                      <div class="col-sm-6">
                        <input class="form-control form-control-sm" type="text" name="phone" id="phone"  placeholder="Phone" required="" pattern="[0-9]*" value="<?php echo isset($phone) ? $phone : '';?>" onkeypress="javascript:return numaric(event,this)">
                        <input type="hidden" id="dial_code" name="dial_code" value="<?php echo $dial_code;?>">
                      </div>
                    </div>
...
// $tzlist = DateTimeZone::listIdentifiers(DateTimeZone::ALL);
                      ...
                      <div class="col-sm-6">
                        <select class="form-control form-control-sm select2" name="region_id" id="region" required="" onchange="getcities(this)">
                          ...
                          if(old('country_id')){
                            ...
                            {
                              ?>
                              <option value="<?=$key?>" <?=(old('region_id') == $key)?'selected':''?>><?=$value ?></option>
                              <?php
                            }
                          }
                          ?>
                    ...
                    <div class="form-group row  mb-4">
                      ...
                      <div class="col-sm-6">
                        <input type="text" class="form-control form-control-sm" id="postal_code" name="postal_code" placeholder="Postal Code" value="{{old('postal_code')}}">
                      </div>
                    </div>
                    ...
                    <div class="form-group row  mb-4">
                      ...
                      <div class="col-sm-6">
                        <textarea class="form-control form-control-sm" id="address" name="address" placeholder="Address">{{ old('address') }}</textarea>
                      </div>
                    </div>
                    <div class="form-group row  mb-1">
                    ...
                    <div class="form-group row  mb-4">
                      ...
                      <div class="col-sm-6">
                        <input type="password" class="form-control form-control-sm" id="password" name="password" placeholder="Password" required="" autocomplete="new-password">
                      </div>
                    </div>
                    <div class="form-group row  mb-1">
                      ...
                      <div class="col-sm-6">
                        <label class="switch s-icons s-outline  s-outline-primary  mb-4 mr-2">
                          <input type="checkbox" id="offline_drive" name="offline_drive" <?=(old('offline_drive'))?'checked':''?>>
                    ...
                    <div class="form-group row  mb-4">
                      ...
                      <div class="col-sm-6">
                        <input type="text" class="form-control form-control-sm" id="driver_code" name="driver_code" placeholder="Driver Code" value="{{old('driver_code')}}">
                      </div>
                    </div>
                    <div class="form-group row  mb-1">
                      ...
                      <div class="col-sm-6">
                        <label class="switch s-icons s-outline  s-outline-primary  mb-4 mr-2">
                          <input type="checkbox" id="is_online" name="is_online" <?=(old('is_online'))?'checked':''?>>
                          <span class="slider round"></span>
                        </label>
                      </div>
                    </div>
                    <div class="form-group row  mb-4">
                      ...
                      <div class="col-sm-6">
                        <label class="switch s-icons s-outline  s-outline-primary  mb-4 mr-2">
                          <input type="checkbox" id="is_activated" name="is_activated" <?=($is_activated==1)?'checked':''?>>
                          <span class="slider round"></span>
                        </label>
                      </div>
                    </div>
...
var f1 = flatpickr(document.getElementById('dob'));
  ...
  window.addEventListener('load', (event) => {
    ...
    iti.setNumber('<?php echo $dial_code; ?>');
    iti.setNumber('<?php echo $phone; ?>');
