@extends('admin.layout.master',['title' => 'View Vehicle Make'])
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php
                                    if ($value->image) {
                                        ?>
                                        <img src="{{url('uploads/vehicle_make/'.$value->image)}}" height="50" width="50">
                                    <?php } else { ?>
                                ...
                                <td class="table-action">
                                    <a href="{{action('Admin\vehicle_makeController@edit',$value->id)}}" class=""><i class="far fa-edit"></i></a>

                                    <form action="{{action('Admin\vehicle_makeController@destroy',$value->id)}}" id="form-<?= $value->id ?>" class="delete-form" method="post">
                                        {{csrf_field()}}
                                        @method('DELETE')
