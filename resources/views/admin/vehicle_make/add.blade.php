@extends('admin.layout.master',['title' => 'Add Vehicle Make'])
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-12  layout-spacing">
                            <div class="statbox widget box box-shadow">
                                ...
                                <div class="widget-content widget-content-area">
                                    ...
                                    @endif
                                    <form action="{!! url('admin/vehicle_make') !!}" method="post" enctype="multipart/form-data" autocomplete="off">
                                         @csrf
                                        <div class="form-group row  mb-4">
                                            <label for="make_name" class="col-sm-2 col-form-label col-form-label-sm">Make Name</label>
                                            <div class="col-sm-6">
                                                <input type="text" class="form-control form-control-sm" id="make_name" name="make_name" placeholder="Make Name">
                                            </div>
                                        </div>
                                        <div class="form-group row mb-4">
