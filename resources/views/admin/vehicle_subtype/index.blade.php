                    ...
                    <table id="zero-config" class="table table-striped dt-responsive nowrap"  style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $value->per_minute_price }}</td>
                                <td>{{ $value->per_km_price }}</td>
                                <td>{{ $value->per_mile_price }}</td>
                                <td class=" ">
                                ...
                                <td class="table-action">
                                    <a href="{{action('Admin\vehicle_subtypeController@edit',$value->id)}}" class=""><i class="far fa-edit"></i></a>

                                    <form action="{{action('Admin\vehicle_subtypeController@destroy',$value->id)}}" id="form-<?= $value->id ?>" class="delete-form" method="post">
                                        {{csrf_field()}}
                                        @method('DELETE')
