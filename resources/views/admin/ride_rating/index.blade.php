...
{
     $title =  'View '. $driver_name. ' ( Driver ) Ratings ';
}elseif(($type == 'rider') && isset($id)) {
    $title =  'View '.$rider_name. ' ( Rider ) Ratings ';
}elseif(($type == 'ride') && isset($id)) {
    $title =  'View Ride ('.$ride_number.') Ratings ';
}else {
    $title =  'View Ratings';
}
?>
                                ...
                                <div id="myTable_filter" class="dataTables_filter d-flex align-items-start">
                                    ...
                                    <div class="mr-2">
                                        <select name="searchcolumn" class="form-control w-auto">
                                            ...
                                            <option value="rating_to" <?= ($searchcolumn == 'rating_to') ? 'selected' : '' ?>>Rating To</option>
                    ...
                    <table id="zero-config" class="table table-striped dt-responsive nowrap" style="width:100%">
                        <thead>
                            ...
                            <tr>
                                ...
                                <th class="sorting" columnName="rating_to" onclick="setUrl('rating_to')">Rating To</th>
                                <th class="sorting" columnName="end_location" onclick="setUrl('end_location')">Rating</th>
                                <th>Comment</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?=$value->rating_to?></td>
                                <td><?=$value->rating?>/5</td>
                                <td><?=$value->rating_comment?></td>
...
<!--                                    <a href="{{action('Admin\rideController@edit',$value->id)}}" class=""><i class="far fa-eye"></i></a>-->
                                    ...
                                    <form action="{{action('Admin\ride_ratingController@destroy',$value->id)}}" id="form-<?= $value->id ?>" class="delete-form" method="post">
                                        {{csrf_field()}}
                                        @method('DELETE')
