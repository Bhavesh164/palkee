<!--  BEGIN NAVBAR  -->
    <div class="header-container fixed-top">
        <header class="header navbar navbar-expand-sm">
            ...
            <ul class="navbar-nav theme-brand flex-row  text-center">
                <li class="nav-item theme-logo">
                    <a href="{{url('admin/home')}}">
                        <img src="{{asset('resources/assets/images/palkee-logo.png')}}" class="navbar-logo" alt="logo">
                    </a>
                </li>
                <li class="nav-item theme-text">
                    <a href="{{url('admin/home')}}" class="nav-link"> PALKEE </a>
                </li>
            ...
            <ul class="navbar-item flex-row navbar-dropdown" style="display: none">
...
<!--                <li class="nav-item dropdown language-dropdown more-dropdown" style="display: none">
                    <div class="dropdown  custom-dropdown-icon">
...
<!--                        <div class="user-profile-section">
                            <div class="media mx-auto">
                                ...
                                <img src="{{asset('resources/admin_template/assets/img/profile-17.jpg')}}" class="img-fluid mr-2" alt="avatar">
                                <div class="media-body">
                                    <h5>Palkee Admin</h5>
                                    <p></p>
                                </div>
