@extends('admin.layout.master',['title' => 'View Countries'])
                            ...
                            <tr>
                                ...
                                <td class=" ">
                                    ...
                                    <?php if ($value->is_activated == '0') { ?>
                                        ...
                                        <div class="t-dot bg-danger" data-toggle="tooltip" data-placement="top" title=""  onclick="javascript:activation(this,'country','countryId','<?= $value->countryId ?>','1')"></div>
                                       
                                    <?php } else { ?>
                                        
                                        <div class="t-dot bg-success" data-toggle="tooltip" data-placement="top" title="" onclick="javascript:activation(this,'country','countryId','<?= $value->countryId ?>','0')" ></div>
