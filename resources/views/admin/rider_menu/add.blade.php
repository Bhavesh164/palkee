@extends('admin.layout.master',['title' => 'Add Rider Menu'])
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-12  layout-spacing">
                            <div class="statbox widget box box-shadow">
                                ...
                                <div class="widget-content widget-content-area">
                                    ...
                                    @endif
                                    <form action="{!! url('admin/rider_menu') !!}" method="post" enctype="multipart/form-data" autocomplete="off">
                                         @csrf
                                         
                                        <div class="form-group row  mb-4">
                                            <label for="menu_name" class="col-sm-2 col-form-label col-form-label-sm">Menu Name</label>
                                            <div class="col-sm-6">
                                                <input type="text" class="form-control form-control-sm" id="menu_name" name="menu_name" placeholder="Menu Name" required="" value="{{ old('menu_name') }}">
                                            </div>
                                        </div>
                                        <div class="form-group row mb-4">
                                        ...
                                        <div class="form-group row  mb-4">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="number" class="form-control form-control-sm" id="priority" name="priority" placeholder="Priority" required="" value="{{ old('priority') }}" min="1">
                                            </div>
                                        </div>
                                        <div class="form-group row  mb-1">
                                            ...
                                            <div class="col-sm-6">
                                                <select class="form-control select2" name="ride_type_id" id="ride_type" required="">
                                                    ...
                                                    <option value="{{$ride_type->id}}" <?= ($ride_type->id == old('ride_type_id'))?'selected':''?> >{{$ride_type->name}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                        <div class="form-group row  mb-1">
                                            ...
                                            <div class="col-sm-6">
                                                <select class="form-control select2" multiple="multiple" name="vehicle_type_ids[]" id="vehicle_type" required="">
                                                    ...
                                                    <option value="{{$vehicle_type->id}}" <?= (old('vehicle_type_ids'))?((in_array($vehicle_type->id,old('vehicle_type_ids')))?'selected':''):''?> >{{$vehicle_type->type_name}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
