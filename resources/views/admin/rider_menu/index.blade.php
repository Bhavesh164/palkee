@extends('admin.layout.master',['title' => 'View Riders Menu'])
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php
                                    if ($value->image) {
                                        ?>
                                        <img src="{{url('uploads/admin/rider_menu/'.$value->image)}}" height="50" width="50">
                                    <?php } else { ?>
                                        <img src="{{url('uploads/default/no-image.png')}}" height="50" width="50"> 
                                    <?php } ?>
                                </td>
                                <td>{{ $value->ride_type }}</td>
                                <td>{{ $value->priority }}</td>
                                <td>{{ $value->vehicle_types }}</td>
                                <td class=" ">
                                ...
                                <td class="table-action">
                                    <a href="{{action('Admin\rider_menuController@edit',$value->id)}}" class=""><i class="far fa-edit"></i></a>

                                    <form action="{{action('Admin\rider_menuController@destroy',$value->id)}}" id="form-<?= $value->id ?>" class="delete-form" method="post">
                                        {{csrf_field()}}
                                        @method('DELETE')
